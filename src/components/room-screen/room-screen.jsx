...
const RoomScreen = ({offers, reviews}) => {
  ...
  const matchedOffer = offers.slice()
    .find((offer) => offer.id.toString() === match.params.id);
...
RoomScreen.propTypes = {
  offers: PropTypes.arrayOf(PropTypes.shape(PropTypes.object)),
  reviews: PropTypes.arrayOf(PropTypes.shape(PropTypes.object))
};
